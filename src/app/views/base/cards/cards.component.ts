...
export class CardsComponent {
  ...
  newCustomer: any = { names: null, document: '', address: null, phone: '', email: '',type:'' };
  
  createNew() {
    this.newCustomer = { names: this.ClientForm.value.names, document: this.ClientForm.value.document, address: this.ClientForm.value.address, phone: this.ClientForm.value.phone, email: this.ClientForm.value.email,type: this.ClientForm.value.type };
  ...
  updateClient() {    
    if (this.currentRowIndex !== undefined) {          
      ...
      this.customers.UpdateCustomer(this.customerList[this.currentRowIndex]).subscribe(
        updatedCustomer => {
